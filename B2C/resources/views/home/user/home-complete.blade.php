                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="10%" class="center">
                                                <ul class="unstyled">
                                                    <li>已完成交易</li>
                                                    <li><a href="orderDetail.html" class="btn" data-toggle="modal" data-target=".order_{{$v['id']}}">订单详情 </a></li>
                                                </ul>
                                            </td>
                                            <td width="10%" class="center">
                                                <ul class="unstyled">
                                                    @if($v['is_comment'] != 1)
													<li><a href="#" class="sui-btn btn-info" data-toggle="modal" data-target=".edit_{{$v['id']}}">评价</a></li>
                                                    @else
                                                    <li><a href="#" class="sui-btn btn-default">已评价</a></li>
                                                    @endif
                                                </ul>
                                            </td>
                                        </tr>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 id="myModalLabel" class="modal-title">商品评价</h4>
                                    </div>
									
									<form action="{{route('home_order_comment')}}" method="post" class="sui-form form-horizontal">
										<div class="modal-body">
											@csrf()
											<div class="control-group">
												<label class="control-label">评论内容：</label>
												<div class="controls">
                                                    <input type="hidden" name="good_id" value="{{$good[$k]['id']}}">
